...
using template.Service.Persistence.DbService;
using template.Service.Persistence.Context;
...
namespace template.Service.Extensions
{
    public static class DiExtensions
    {
        public static IServiceCollection ConfigureDiEnvironment(this IServiceCollection services, IConfiguration Configuration)
        {
            ...
            //services.AddDbContext<DBContext>(options => options.UseSqlServer(Configuration.GetConnectionString("template.Service"), providerOptions => providerOptions.CommandTimeout(120)));
